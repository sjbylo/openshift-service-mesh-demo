...
oc get csv -n openshift-operators -oname | cut -d/ -f2 | grep -e ^kiali-operator -e ^servicemeshoperator -e ^jaeger-operator | xargs -L1 oc delete -n openshift-operators csv || true
